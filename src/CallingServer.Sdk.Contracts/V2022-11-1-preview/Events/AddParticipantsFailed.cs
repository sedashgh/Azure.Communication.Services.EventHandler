...
public class AddParticipantsFailed : BaseCallingEvent
{
    ...
    public AddParticipantsFailed(string operationContext, ResultInformation resultInformation, IEnumerable<CommunicationIdentifier> participants, string callConnectionId, string? serverCallId, string correlationId)
